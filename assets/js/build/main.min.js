...
var SCB = function($) {
    function _init() {
        _resize(), $document = $(document), $body = $("body"), $content = $("#main-content"), 
        $nav = $(".site-nav"), _initNav(), _bIntro(), $(document).keyup(function(e) {
            27 === e.keyCode && _hideNav();
        });
    }
    function _scrollBody(element, duration, delay) {
        $("#wpadminbar").length ? wpOffset = $("#wpadminbar").height() : wpOffset = 0, element.velocity("scroll", {
            duration: duration,
            delay: delay,
            offset: -wpOffset
        }, "easeOutSine");
    ...
    function _initNav() {
        $(".nav-toggle").on("click", function() {
            $(this).toggleClass("-active"), $(".site-nav-wrap").is(".-active") ? _hideNav() : _showNav();
        });
        var navItem = $(".site-nav li"), navItems = $.makeArray(navItem), navCount = navItems.length;
    ...
    function _resize() {
        screenWidth = document.documentElement.clientWidth, breakpoint_small = screenWidth > 480, 
        breakpoint_medium = screenWidth > 768, breakpoint_large = screenWidth > 1024, breakpoint_huge = screenWidth > 3e3;
    }
    function _scroll() {
        var scrolltop = $(window).scrollTop();
        $("#tagline").css("opacity", 1 / (scrolltop / 25)), $("#tagline").css("transform", "translateY(-" + scrolltop / 3 + "px)");
    }
    var $content, $body, $document, $nav, breakpoint_small = !1, breakpoint_medium = !1, breakpoint_large = !1, breakpoint_huge = !1;
    return {
        init: _init,
        resize: _resize,
        scroll: _scroll,
...
jQuery(document).ready(SCB.init), jQuery(window).resize(SCB.resize), jQuery(window).on("DOMMouseScroll mousewheel scroll", SCB.scroll);